        ...
        <body data-spy="scroll" data-target="#main-nav" id="home">
                ...
                <div class="container">
                        ...
                        <section id="about" class="bg-light py-5">
                            ...
                            <div class="row">
                              <div class="col  ">
                                <h1 class="display-4 text-dark text-center font-weight-bold">Construction and maintainance of hire mast</h1>
                                <br>
                        ...
                        <div class="col">
                        <p>
                          Masts are a specialized type of structure commonly 
                         used for Telecommunications to support equipment at substantial heights. 


                          <br><br>
                          Masts are utilized to achieve the maximum in elevation and loading at an economical cost. The addition of heavy braced sections and
                          arm guyed wire points allow a mast or self-support tower to be engineered custom to its loading specifications.
                          <br><br>
                          Masts fabrication and galvanizing and installation offered by <b class="text-danger">TML</b>  are 
                          designed to withstand the harshest environmental conditions.The primed and painted steel 
                          elements and the reinforced base plates of these masts ensure stability. One of the 
                          advantages of the our masts is the increased rigidity of the section and their greater stability in cases of buckling.
                      ...
                      <div class="col-md-6 d-none d-lg-block">
                        ...
                        <div class="container" style="height:100vh">
                        <div class="col">
                          <img src="img/mast.jpg" height="550" width="600" alt="">
                        </div>
                        </div>
                        </div>
                      </div>
                          ...
                          <section id="" class="">
                              ...
                              <div class="row">
                                <div class="col text-center py-5">
                                  <br>
                                  <img src="img/dish.jpg" width="1080" height="400" alt="">
                                </div>
                              </div>
                            </section>            
                        </div>
