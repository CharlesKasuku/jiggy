        ...
        <body data-spy="scroll" data-target="#main-nav" id="home">
                ...
                <div class="container">
                        ...
                        <section id="about" class="bg-light py-5">
                            ...
                            <div class="row">
                              <div class="col  ">
                                <h1 class="display-4 text-dark text-center font-weight-bold">Networking Solutions</h1>
                                <br>
                        ...
                        <div class="col">
                        <p>
                          Trade Magnate Limited  provide horizontal data cable, and telecommunication installation 
                          services for your company. We offer both computer and cable services, giving your project
                           a "single source" vendor. This turn-key service insures that your networking project will
                            be closely engineered, and save you time and money.


                          <br><br>
                          Trade Magnate Limited is a company that specialises in setting up modern structured cabling systems for commercial use. 
                          We can help you enhance the current performance of your network 
                          system and make sure your daily company operations have a reliable support system.
                          <br><br>
                          Business environment in Kenya is fast changing and it need a proper solution to make the communication faster and reliable. A good service provider can offer 
                          business in Kenya impeccable telephone set up that certainly take enterprise to reach new levels.<BR><BR>
                          When it comes to the systems and telephone cabling Kenya, <b class="text-danger">TML</b> is the best.
                          <br><br>
                      ...
                      <div class="col-md-6 d-none d-lg-block">
                        ...
                        <div class="container" style="height:100vh">
                        <div class="col">
                          <img src="img/networkingstructured-cabling.jpg" height="550" width="600" alt="">
                        </div>
                        </div>
                        </div>
                      </div>
                          ...
                          <section id="" class="">
                              ...
                              <div class="row">
                                <div class="col text-center py-5">
                                  <br>
                                  <img src="img/structuredcable01.jpg" width="1080" height="400" alt="">
                                </div>
                              </div>
                            </section>            
                        </div>
