        ...
        <body data-spy="scroll" data-target="#main-nav" id="home">
                ...
                <div class="container">
                        ...
                        <section id="about" class="bg-light py-5">
                            ...
                            <div class="row">
                              <div class="col  ">
                                <h1 class="display-4 text-dark text-center font-weight-bold">Onsite/Offsite Backup Solutions</h1>
                                <br>
                        ...
                        <div class="col">
                        <p>
                        Loss of data for any business can be a huge and debilitating setback. 
                        Imagine losing your financial accounts, confidential contracts, billing
                        information
                        and even regular operational documents.<br><br> What if your flagship
                        business software or 
                        system fails?<br><br>

                        Setbacks due to data loss is something that most Kenyan businesses are 
                        beginning to notice,
                        with the virus attacks that have happened to several businesses and hospitals.<br><br>
                        Organizations have had to cough up millions of shillings to get back their data.<br><br>
                        Don’t get affected by this,
                        Partner with us and we will ensure that your computer systems are running, and if they fail,
                        that
                        you can get them running again quickly. <br><br>All this through our comprehensive Onsite and Offisite Backup solution
                      ...
                      <div class="col-md-6 d-none d-lg-block">
                        ...
                        <div class="container" style="height:100vh">
                        <div class="col">
                          <img src="img/onsite.jpg" height="400" width="600" alt="">
                        </div>
                        </div>
                        </div>
                      </div>
                          ...
                          <section id="" class="">
                              ...
                              <div class="row">
                                <div class="col text-center py-5">
                                  <br>
                                  <img src="img/backup[.jpg" width="800" height="400" alt="">
                                </div>
                              </div>
                            </section>            
                        </div>
