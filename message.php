        ...
        <body data-spy="scroll" data-target="#main-nav" id="home">
                      ...
                      <ul class="navbar-nav ml-right">
                        <li class="nav-item dropdown active">
                          ...
                          <div class="dropdown-menu  bg-danger text-light">
                            <a href="index.html" class="dropdown-item">Who We Are</a>
                            <a href="index.html" class="dropdown-item">Our Solutions</a>
                            <a href="index.html" class="dropdown-item">Our Pages</a>
                ...
                <div class="container">
                    <section id="about" class="bg-light py-5">
                        ...
                        <div class="row">
                          <div class="col  ">
                            <h1 class="display-4 text-dark text-center font-weight-bold">THANK YOU WE WILL GET BACK TO YOU AS SOON AS POSSIBLE</h1>
                            <br>
                          </div>
                        </div>
                      </section>            
