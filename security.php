...
if ($query) {
                ...
                echo 'alert("quote submitted successfully");'; 
        ...
        <body data-spy="scroll" data-target="#main-nav" id="home">
                ...
                <div class="container">
                        ...
                        <section id="about" class="bg-light py-5">
                            ...
                            <div class="row">
                              <div class="col  ">
                                <h1 class="display-4 text-dark text-center font-weight-bold">Security Solutions</h1>
                                <br>
                        ...
                        <div class="col">
                        <p>
                          Our Security Solutions Division is one of the Best Security provider in East Africa.<br>
                          We design, install and maintain fully intergrated electronic secuirty solutions, including CCTV cameras,
                          intruder alarms, access control and barries.<br>
                          Our company provides you with latest digital technologies including <br><br>
                          1. Biometric<br>
                          2. Network intergration<br>
                          3. Remote monitoring <br>
                          thus we select the best technologies to solve your securty issues and best products and solutions that offers
                          stabililty and effective performance.<br><br>

                          we offers a comprehensive range of CCTV Surveillance system designed to increase the level of security
                          we normally choose the most appropriate cameras system for the risk at hand and the finance available.<br>

                          We provide Customizable, affordable and expandable access control solution that will enables organisation to 
                          protect and control assests, properties, operations and information.
                      ...
                      <div class="col-md-6 d-none d-lg-block">
                        ...
                        <div class="container" style="height:100vh">
                        <div class="col">
                          <img src="img/CCTVCAMERA-1.png" height="550" width="600" alt="">
                        </div>
                        </div>
                        </div>
                      </div>
                          ...
                          <section id="" class="">
                              ...
                              <div class="row">
                                <div class="col text-center py-5">
                                  <br>
                                  <img src="img/image 6.jpg" width="1080" height="400" alt="">
                                </div>
                              </div>
                            </section>            
                        </div>
