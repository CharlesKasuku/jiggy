        ...
        <body data-spy="scroll" data-target="#main-nav" id="home">
                ...
                <div class="container">
                        ...
                        <section id="about" class="bg-light py-5">
                            ...
                            <div class="row">
                              <div class="col  ">
                                <h1 class="display-4 text-dark text-center font-weight-bold">Hardware and Software Solutions</h1>
                                <br>
...
Success to us is the ability to help others succeed in their goals and passions.<br><br>

Trade Magnate Limited is not your normal IT company.<br><br>
We are here to make a difference and create a revolution in IT and business development!<br>
                      ...
                      <div class="col-md-6 d-none d-lg-block">
                        ...
                        <div class="container" style="height:100vh">
                        <div class="col">
                          <img src="img/software 1.png" height="550" width="650" alt="">
                        </div>
                        </div>
                        </div>
                      </div>
                          ...
                          <section id="" class="">
                              ...
                              <div class="row">
                                <div class="col text-center py-5">
                                  <br>
                                  <img src="img/HARDWARE 4.jpg" width="1080" height="400" alt="">
                                </div>
                              </div>
                            </section>            
                        </div>
