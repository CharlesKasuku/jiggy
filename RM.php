        ...
        <body data-spy="scroll" data-target="#main-nav" id="home">
                ...
                <div class="container">
                        ...
                        <section id="about" class="bg-light py-5">
                            ...
                            <div class="row">
                              <div class="col  ">
                                <h1 class="display-4 text-dark text-center font-weight-bold">Repair & Maintenance Solution</h1>
                                <br>
                        ...
                        <div class="col">
                        <p>
                          Trade Magnate Limited delivers Anual Maintenance contract repair Maintenance services<br><br>
                          We provide intergrated ICT Services support for both desktop and laptop computer onsite<br><br>
                          We strive to achieve this by ensuring we focus individually on each project and also build a heathy relationship
                          with our clients.
                          <br><br>
                          Through computer repair services, we repair all faulty and broken down computers within your organisation and
                          fully bring them to recovery thus aiding in continued business process
                          <br><br>
                          Through Preventive Maintenance we relief a Company or individual from tragedy Strikes, by fully run preventive
                          maintenance and detect any fault or anticipation failure and sort it out before it strikes
                          <br><br>
                      ...
                      <div class="col-md-6 d-none d-lg-block">
                        ...
                        <div class="container" style="height:100vh">
                        <div class="col">
                          <img src="img/computer-repair-services.png" height="550" width="600" alt="">
                        </div>
                        </div>
                        </div>
                      </div>
                          ...
                          <section id="" class="">
                              ...
                              <div class="row">
                                <div class="col text-center py-5">
                                  <br>
                                  <img src="img/computer-repair-services.png" width="1080" height="400" alt="">
                                </div>
                              </div>
                            </section>            
                        </div>
